...
var Comment="", Tid = null, turnN=1, W = null, ClipDT="";
...
function pythonSolve() {
    ...
    W = window.open('python/Cube2phase_Fast2.py?value1='+rotation,"Python",'height=100,width=480,left='+(window.screenX+300)+',dependent=yes,scrollbars=no');
